...
//  Updated with input validation and removed test credentials
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px' }}>
          ...
          <p style={{
            ...
            Motisha John Mafukashe — R2211825P
          </p>
        </div>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          />
          {errors.username && (
            <div style={errStyle}>⚠ {errors.username}</div>
          )}
        </div>
        ...
        <button
          ...
          onMouseEnter={e => {
            if (!loading) e.target.style.background = '#2a4a8a';
          }}
          onMouseLeave={e => {
            if (!loading) e.target.style.background = '#1a2d5a';
          }}
        >
          {loading ? '🔄 Logging in...' : 'Login →'}
        </button>

        {/* ── Contact note — replaces test credentials ── */}
        <div style={{
